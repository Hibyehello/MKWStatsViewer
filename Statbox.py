...
class StatBox:
    ...
    def stats(self, current_displayed):
        ...
        self.layout.addWidget(self.SpeedLabel, 3, 0)
        self.layout.addWidget(self.SpeedText, 3, 1)
        self.layout.addWidget(self.WeightLabel, 4, 0)
        self.layout.addWidget(self.WeightText, 4, 1)
        self.layout.addWidget(self.SpeedInTurnLabel, 5, 0)
        self.layout.addWidget(self.SpeedInTurnText, 5, 1)
        self.layout.addWidget(self.numWheelLabel, 6, 0)
        self.layout.addWidget(self.numWheelText, 6, 1)
        self.layout.addWidget(self.DriftTypeLabel, 7, 0)
        self.layout.addWidget(self.DriftTypeText, 7, 1)
        self.layout.addWidget(self.WeightClassLabel, 8, 0)
        self.layout.addWidget(self.WeightClassText, 8, 1)
